...
```
cd existing_repo
git remote add origin https://git.ica.ia-hc.net/grp-ds-ai/cc-local-dev-template.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.ica.ia-hc.net/grp-ds-ai/cc-local-dev-template/-/settings/integrations)
